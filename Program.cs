...
using SystemSnapshotWebServer.Core.Web;
using SystemSnapshotWebServer.GUI;
using SystemSnapshotWebServer.Reports;
...
namespace SystemSnapshotWebServer
{
    static class Program
    {
        ...
        /// </summary>
        public const string Website = "http://SystemSnapshotWebServer.com";
